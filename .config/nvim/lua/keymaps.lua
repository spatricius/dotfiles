...
function M.setup()
  ...
  -- Trouble diagnostics
  register_group({ '<leader>x', group = 'Trouble' })
  vim.keymap.set('n', '<leader>xx', '<cmd>Trouble diagnostics toggle<CR>', { desc = 'Trouble [D]iagnostics' })
  vim.keymap.set('n', '<leader>xX', '<cmd>Trouble diagnostics toggle filter.buf=0<CR>', { desc = 'Trouble [B]uffer diagnostics' })
  vim.keymap.set('n', '<leader>xq', '<cmd>Trouble qflist toggle<CR>', { desc = 'Trouble [Q]uickfix list' })
  vim.keymap.set('n', '<leader>xl', '<cmd>Trouble loclist toggle<CR>', { desc = 'Trouble [L]ocation list' })
  vim.keymap.set('n', '<leader>xr', '<cmd>Trouble lsp_references toggle focus=false<CR>', { desc = 'Trouble LSP [R]eferences' })
  vim.keymap.set('n', '<leader>xi', '<cmd>Trouble lsp_implementations toggle focus=false<CR>', { desc = 'Trouble LSP [I]mplementations' })
